...
Map](https://agrivoltaicsmap.ise.fraunhofer.de/):
...
- Cached results are stored in `data/cache/` and are not included in the
  package repository. Each user runs `collect_site_data()` on their own
  machine.
